...
use Paybox\Epayment\Model\Ui\PbxepcbConfig;

/**
 * Class ConfigProvider
 */
final class PbxepcbConfigProvider implements ConfigProviderInterface
{
    const CODE = 'pbxep_cb';
    /**
    ...
    public function getCards()
    {
        ...
        $pbxepcbConfig = $object_manager->get('Paybox\Epayment\Model\Ui\PbxepcbConfig');
