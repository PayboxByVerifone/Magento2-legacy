...
use Paybox\Epayment\Model\Ui\PbxepfinancialConfig;

/**
 * Class ConfigProvider
 */
final class PbxepfinancialConfigProvider implements ConfigProviderInterface
{
    ...
    public function getCards()
    {
        ...
        $pbxepfinancialConfig = $object_manager->get('Paybox\Epayment\Model\Ui\PbxepfinancialConfig');
